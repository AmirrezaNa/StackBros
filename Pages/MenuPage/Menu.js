const MENU_GROUPS = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: { de: "Pute Ananas", en: "Turkey & Pineapple" }, desc: { de: "", en: "" }, prices: ["8.00"], image: "../../images/PuteAnanas.JPG" },
            { name: { de: "Pute Bacon", en: "Turkey Bacon" }, desc: { de: "", en: "" }, prices: ["8.00"], image: "../../images/PuteBacon.JPG" },
